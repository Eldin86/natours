        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successufully');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successufully!"));
            _context.next = 11;
            break;
...
var stripe = Stripe('pk_test_51KGRfYJ6K8TNraGb6OS9MuKqa26EGwWo585VPcSrE38XLbO3wqWkaYm6o5YW3bT6dqVZczAQsvHj4bww23pnONOO00oquyGfQb');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2. Create checkout form + process charge credit card
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              document.querySelector('.btn--save-password').textContent = 'Save password'; //Clear input fields after successuful password update
